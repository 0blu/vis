...
class BezierEdgeBase extends EdgeBase {
  ...
  _bezierCurve(ctx, values, viaNode1, viaNode2) {
    ...
    if(colors.fromNode !== void 0 && colors.fromNode !== void 0)
    {
      ...
      this._bezierCurvePart(ctx, parts.left.points, '#00ff00');

      if(colors.toNode !== void 0 && colors.toNode !== void 0)
        ctx.strokeStyle = colors.toNode;
      this._bezierCurvePart(ctx, parts.right.points, '#00ff00');
