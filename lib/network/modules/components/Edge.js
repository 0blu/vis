  ...
  static parseOptions(parentOptions, newOptions, allowDeletion = false, globalOptions = {}) {
    ...
    if (newOptions.color !== undefined && newOptions.color !== null) {
      ...
      if (util.isString(newOptions.color)) {
        ...
        if (newOptions.color.fromNode  !== undefined) {parentOptions.color.fromNode  = newOptions.color.fromNode;  colorsDefined = true;}
        if (newOptions.color.toNode    !== undefined) {parentOptions.color.toNode    = newOptions.color.toNode;    colorsDefined = true;}
